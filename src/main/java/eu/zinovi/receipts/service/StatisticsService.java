...
public class StatisticsService {
    ...
    public StatisticsService(StatisticsToView statisticsToView, StatisticsRepository statisticsRepository, ItemRepository itemRepository, ReceiptRepository receiptRepository, CompanyRepository companyRepository, StoreRepository storeRepository, UserRepository userRepository) {
